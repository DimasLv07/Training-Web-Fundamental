    ...
    <div class="row m-0 h-100" style="background-image: linear-gradient();">
        ...
        <div class="col p-0 d-flex justify-content-center align-items-center" >
            <form class="w-75">
                ...
                <a href="{{route('welcome')}}" type="button" class="btn btn-primary">Login</a>
                <p class="akun text-center mt-3">Don't have account? <a class="fw-bold" href="{{route('signup')}}"> SignUp</a></p>
            </form>
        </div>
